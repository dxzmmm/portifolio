      ...
      >
        ...
        <div className="relative flex flex-col items-center justify-center py-5 text-center h-dvh">
          <div className="flex flex-col sm:flex-row items-center sm:gap-10 gap-5  mx-10">
            ...
            <div className="flex-col flex sm:gap-2 items-center sm:items-baseline">
              <div className="flex flex-col">
                ...
                <div className="flex items-center">
                  <h1 className=" text-4xl sm:text-6xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-violet-500 ">
                    Eu sou o Yuri
                  </h1>
                </div>
              </div>
              ...
              <div className="sm:flex flex-col sm:flex-row items-center flex sm:gap-13">
                <div className="gap-5 flex">
                  <div>
                    <a href="http://wa.me/+5531988318187" target="_blank">
                      <button className="w-34 h-10 sm:w-45 text-[10px] bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-all duration-300 transform hover:scale-105  cursor-pointer sm:text-sm font-semibold">
                ...
                <div class="flex gap-6 sm:gap-4">
                  <a href="https://github.com/dxzmmm " target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="size-8 mt-4 sm:mt-1 sm:size-6 fill-white hover:fill-zinc-700 transition"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <a href="https://www.instagram.com/dxzmmm/" target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="size-8 mt-4 sm:mt-1 sm:size-6 fill-white hover:fill-pink-500 transition"
                      viewBox="0 0 24 24"
                    >
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="size-8 mt-4 sm:mt-1 sm:size-6 fill-white hover:fill-blue-600 transition"
                      viewBox="0 0 24 24"
                    >
